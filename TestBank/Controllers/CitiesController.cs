...
namespace TestBank.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityCode,CityName,Statecode")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityCode,CityName,Statecode")] City city)
        {
            if (ModelState.IsValid)
            {
